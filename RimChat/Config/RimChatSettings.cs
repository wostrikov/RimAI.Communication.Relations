 ...
 ///</summary>
    ...
    public partial class RimChatSettings : ModSettings
    {
        ...
        public override void ExposeData()
        {
            ...
            Scribe_Values.Look(ref SelfieSelectedColonistThingId, "SelfieSelectedColonistThingId", string.Empty);
            Scribe_Values.Look(ref SelfiePromptText, "SelfiePromptText", string.Empty);
            Scribe_Values.Look(ref SelfieCaptionText, "SelfieCaptionText", string.Empty);
            Scribe_Values.Look(ref SelfieSizeText, "SelfieSizeText", DiplomacyImageApiConfig.DefaultImageSize);
            Scribe_Values.Look(ref SelfieWatermark, "SelfieWatermark", false);
            Scribe_Values.Look(ref SelfieIncludeAge, "SelfieIncludeAge", true);
            Scribe_Values.Look(ref SelfieIncludeGender, "SelfieIncludeGender", true);
            Scribe_Values.Look(ref SelfieIncludeFaction, "SelfieIncludeFaction", true);
            Scribe_Values.Look(ref SelfieIncludeRole, "SelfieIncludeRole", true);
            Scribe_Values.Look(ref SelfieIncludeBodyType, "SelfieIncludeBodyType", true);
            Scribe_Values.Look(ref SelfieIncludeHair, "SelfieIncludeHair", true);
            Scribe_Values.Look(ref SelfieIncludeXenotype, "SelfieIncludeXenotype", true);
            Scribe_Values.Look(ref SelfieIncludeApparel, "SelfieIncludeApparel", true);
            Scribe_Values.Look(ref SelfieIncludeHediffs, "SelfieIncludeHediffs", true);
            Scribe_Values.Look(ref SelfieIncludeHealth, "SelfieIncludeHealth", true);
            Scribe_Values.Look(ref SelfieIncludeWeapon, "SelfieIncludeWeapon", true);
            Scribe_Values.Look(ref SelfieIncludeEquipment, "SelfieIncludeEquipment", true);
            Scribe_Values.Look(ref SelfieIncludePositivePrompt, "SelfieIncludePositivePrompt", false);
            Scribe_Values.Look(ref SelfieIncludeNegativePrompt, "SelfieIncludeNegativePrompt", false);
            Scribe_Values.Look(ref SelfiePositivePromptText, "SelfiePositivePromptText", string.Empty);
            Scribe_Values.Look(ref SelfieNegativePromptText, "SelfieNegativePromptText", string.Empty);
            ...
            Scribe_Values.Look(ref Temperature, "Temperature", 0.5f);
...
#pragma warning restore CS0618
            ...
            if (SelfieSelectedColonistThingId == null) SelfieSelectedColonistThingId = string.Empty;
            if (string.IsNullOrWhiteSpace(SelfiePromptText)) SelfiePromptText = "帮我生成图片：将图片的动漫风格角色转为低饱和二次元摄影cos风格，做自拍动作，采用现实对脸自拍构图，保留核心服饰元素，背景设为派系典型场景，光线偏暖调以增强氛围感，全身照。比例 4:3。";
            if (SelfieCaptionText == null) SelfieCaptionText = string.Empty;
            if (string.IsNullOrWhiteSpace(SelfieSizeText)) SelfieSizeText = DiplomacyImageApiConfig.DefaultImageSize;
            if (SelfiePositivePromptText == null) SelfiePositivePromptText = string.Empty;
            if (SelfieNegativePromptText == null) SelfieNegativePromptText = string.Empty;
