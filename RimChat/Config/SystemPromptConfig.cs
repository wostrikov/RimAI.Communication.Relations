 ...
 ///</summary>
        private void InitializeMinimalDefaults()
        {
            ...
            ApiActions = new List<ApiActionConfig>
            {
                ...
                new ApiActionConfig("request_caravan", "Request trade caravan (goods are determined by faction trade list, not by you or the player)", "Only when relations are not hostile and this faction's RimChat caravan request cooldown is ready (7 days per faction). Original comms-console requests are outside this cooldown."),
