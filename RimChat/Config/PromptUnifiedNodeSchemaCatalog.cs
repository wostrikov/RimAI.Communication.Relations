...
namespace RimChat.Config
{
    ...
    internal static class PromptUnifiedNodeSchemaCatalog
    {
        ...
        private static readonly PromptUnifiedNodeSchemaItem[] NodeItems =
        {
            ...
            new PromptUnifiedNodeSchemaItem("rpg_action_priority", "RimChat_PromptNode_RpgActionPriority", "RPG Action Priority"),
            new PromptUnifiedNodeSchemaItem("rpg_proactive_romance", "RimChat_PromptNode_RpgProactiveRomance", "RPG Proactive Romance"),
            new PromptUnifiedNodeSchemaItem("rpg_proactive_social", "RimChat_PromptNode_RpgProactiveSocial", "RPG Proactive Social Action"),
