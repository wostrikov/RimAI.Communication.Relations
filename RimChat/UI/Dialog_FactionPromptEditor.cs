...
namespace Ustas.RimAI.Communication.Relations.UI
{
    ...
    public class Dialog_FactionPromptEditor : Window
    {
        ...
        public override void DoWindowContents(Rect inRect)
        {
            ...
            Widgets.Label(titleRect, $"{factionConfig.DisplayName} - {"RimChat_PromptTemplateEditor".Translate()}");
            ...
            if (Widgets.ButtonText(toggleRect, showPreview ? "RimChat_HidePreview".Translate() : "RimChat_ShowPreview".Translate()))
            {
            ...
            Widgets.Label(descRect, "RimChat_PromptTemplateEditorDesc".Translate());
            ...
            if (showPreview)
            {
                ...
                Widgets.Label(previewLabelRect, "RimChat_PreviewLabel".Translate());
                GUI.color = Color.white;
                currentY += 24f;
