...
namespace Ustas.RimAI.Communication.Relations.UI
{
    ...
    {
        private bool TryHandleSendGiftActionWithConfirmation(
            AIAction action,
            ...
            out ActionExecutionOutcome outcome)
        {
            ...
            int silver = ReadInt(action, "silver", 0);
            int goodwillGain = ReadInt(action, "goodwill_gain", 0);
            if (silver <= 0)
            {
        ...
        private void ShowSendGiftConfirmationDialog(
            FactionDialogueSession currentSession,
            Faction currentFaction,
            AIAction action,
        ...
        private void CommitPreparedSendGift(
            FactionDialogueSession currentSession,
            Faction currentFaction,
            AIAction action,
            PreparedSendGiftData preparedData)
        ...
        private void CancelPreparedSendGift(FactionDialogueSession currentSession, Faction currentFaction)
        {
