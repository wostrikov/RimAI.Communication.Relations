...
{
    /// <summary>Bound-need arbitration for item airdrop.</summary>
    internal sealed class GameAIAirdropBoundNeed : GameAIInterfaceCollaborator
    {
        internal GameAIAirdropBoundNeed(GameAIInterface owner) : base(owner)
        {
        }


        internal APIResult TryApplyBoundNeedArbitration(
            Faction faction,
            ...
            out ItemAirdropBoundNeedInfo boundNeed)
        {
            ...
            if (resolvedBoundNeed.Record?.Def == null)
            {
                ...
                Owner.Parts.CooldownOps.RecordAPICall("RequestItemAirdrop.BoundNeedReject", false, diagnostics, message);
                return Owner.Parts.AirdropDrop.FailFastAirdrop("bound_need_unresolved", message, faction, parameters, diagnostics, sendLetter: false);
            }
                ...
                !ThingDefResolver.CanCandidateForNeed(resolvedBoundNeed.Record, intent.Family))
            {
                ...
                if (boundFamily == ItemAirdropNeedFamily.Unknown)
                {
                    ...
                    Owner.Parts.CooldownOps.RecordAPICall("RequestItemAirdrop.BoundNeedReject", false, diagnostics, message);
                    return Owner.Parts.AirdropDrop.FailFastAirdrop("bound_need_family_conflict", message, faction, parameters, diagnostics, sendLetter: false);
                }
                ...
                Owner.Parts.CooldownOps.RecordAPICall("RequestItemAirdrop.BoundNeedFamilyOverride", true, overrideDiagnostics, overrideMessage);
            }
            ...
            RegisterBoundNeedConflict(
                ...
                "RimChat_ItemAirdropBoundNeedCandidateConflictSystem"
                    .Translate(resolvedBoundNeed.Label, resolvedBoundNeed.DefName)
                    .ToString());
            Owner.Parts.CooldownOps.RecordAPICall("RequestItemAirdrop.BoundNeedArbitrated", true, injectDiagnostics);
            return APIResult.SuccessResult("Bound need injected into candidate pack.", resolvedBoundNeed);
        }

        internal static bool TryResolveBoundNeedInfo(
            Dictionary<string, object> parameters,
            out ItemAirdropBoundNeedInfo boundNeed)
        {
            boundNeed = null;
            string defName = GameAIAirdropDrop.ReadString(parameters, ItemAirdropParameterKeys.BoundNeedDefName);
            ...
            boundNeed = new ItemAirdropBoundNeedInfo
            {
                ...
                Label = GameAIAirdropDrop.ReadString(parameters, ItemAirdropParameterKeys.BoundNeedLabel),
                SearchText = GameAIAirdropDrop.ReadString(parameters, ItemAirdropParameterKeys.BoundNeedSearchText),
                Record = record
            };
        ...
        internal static ItemAirdropCandidate BuildInjectedBoundNeedCandidate(
            ItemAirdropCandidatePack candidatePack,
        ...
        internal static void MarkBoundNeedConflict(
            ItemAirdropCandidatePack candidatePack,
            string conflictCode,
        ...
        internal static void RegisterBoundNeedConflict(
            Dictionary<string, object> parameters,
            string conflictCode,
            string message)
        {
        ...
        internal static string BuildBoundNeedAuditDetails(
            ItemAirdropBoundNeedInfo boundNeed,
            ItemAirdropIntent intent,
            string code,
        ...
        internal static ItemAirdropNeedFamily InferNeedFamilyFromBoundNeed(ThingDefRecord record)
        {
            if (record?.Def == null)
            {
        ...
        internal static void ClearStaleBoundNeedParameters(Dictionary<string, object> parameters)
        {
            if (parameters == null)
            {
                return;
