...
namespace Ustas.RimAI.Communication.Relations.DiplomacySystem
{
    ...
    public partial class GameAIInterface
    {
        ...
        private List<RelationsQuestPublicationRecord> _rimChatQuestPublicationRecords = new List<RelationsQuestPublicationRecord>();
        private List<RelationsFactionQuestRuntimeRecord> _rimChatFactionQuestRuntimeRecords = new List<RelationsFactionQuestRuntimeRecord>();
        private List<RelationsFactionQuestCompletionRecord> _rimChatFactionQuestCompletionRecords = new List<RelationsFactionQuestCompletionRecord>();
        ...
        private void UpsertQuestPublicationRecord(RelationsQuestPublicationRecord record)
        {
            _rimChatQuestPublicationRecords ??= new List<RelationsQuestPublicationRecord>();
        ...
        private void TryFinalizeEndedQuestRecord(RelationsFactionQuestRuntimeRecord runtimeRecord, Quest liveQuest, bool succeeded)
        {
        ...
        private static bool IsCompletionRecordFactionMatch(RelationsFactionQuestCompletionRecord record, string factionId, string factionDefName)
        {
            if (record == null)
            {
                return false;
