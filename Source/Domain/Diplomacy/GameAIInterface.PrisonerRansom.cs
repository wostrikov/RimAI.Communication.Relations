...
namespace Ustas.RimAI.Communication.Relations.DiplomacySystem
{
    ...
    public partial class GameAIInterface
    {
        ...
        private static int ResolveContractTimeoutTicks(PrisonerRansomPrepareData preparedData, RelationsSettings settings)
        {
        ...
        private static string NormalizeRansomPaymentMode(string paymentMode, RelationsSettings settings)
        {
        ...
        private static bool TryDeliverRansomSilver(Map map, int silverAmount, RelationsSettings settings, out IntVec3 dropCell)
        {
