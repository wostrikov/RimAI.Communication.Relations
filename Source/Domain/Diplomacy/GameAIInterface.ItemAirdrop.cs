...
namespace Ustas.RimAI.Communication.Relations.DiplomacySystem
{
    ...
    public partial class GameAIInterface
    {
        ...
        private List<string> ExpandNeedAliasesWithAi(string need, string constraints, RelationsSettings settings)
        {
            _ = need;
            _ = constraints;
            _ = settings;
        ...
        private static int ComputeMaxDeliverableByStacks(ThingDef def, RelationsSettings settings)
        {
        ...
        private static int ResolveBudget(Dictionary<string, object> parameters, string scenario, RelationsSettings settings, Map map)
        {
