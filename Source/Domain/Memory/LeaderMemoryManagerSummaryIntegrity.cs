...
{
        internal sealed class LeaderMemoryManagerSummaryIntegrity : LeaderMemoryManagerCollaborator
    {
        internal LeaderMemoryManagerSummaryIntegrity(LeaderMemoryManager owner) : base(owner)
        {
        }


        internal readonly HashSet<string> _summaryRepairAttempted = new HashSet<string>(StringComparer.Ordinal);
        internal readonly HashSet<string> _summaryRepairInFlight = new HashSet<string>(StringComparer.Ordinal);

        internal bool TryBuildSanitizedSummaryRecord(
        ...
        internal void TryQueueSummaryRepair(
            Faction faction,
            ...
            string reasonTag)
        {
            ...
            string repairKey = LeaderMemoryManager.BuildSummaryRepairKey(faction, original);
            ...
            AIChatServiceAsync.Instance.SendChatRequestAsync(
                ...
                onSuccess: response =>
                {
                    try
                    {
                        LeaderMemoryManager.ParseRepairResponse(response, out string repairedSummary, out List<string> repairedFacts);
                        ...
                        if (!Owner.TryBuildSanitizedSummaryRecord(repaired, out CrossChannelSummaryRecord sanitized, out string sanitizeReason))
                        {
        ...
        internal static string BuildSummaryRepairKey(Faction faction, CrossChannelSummaryRecord record)
        {
        ...
        internal static void ParseRepairResponse(string raw, out string summary, out List<string> facts)
        {
