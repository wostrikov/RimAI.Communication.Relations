...
namespace Ustas.RimAI.Communication.Relations.Config
{
    ...
    internal sealed class RimTalkChannelCompatConfig
    {
        ...
        public int PresetInjectionMaxEntries = RelationsSettings.RimTalkPresetInjectionLimitUnlimited;
        public int PresetInjectionMaxChars = RelationsSettings.RimTalkPresetInjectionLimitUnlimited;
        public string CompatTemplate = RelationsSettings.DefaultRimTalkCompatTemplate;
        ...
        public void NormalizeWith(RimTalkChannelCompatConfig fallback)
        {
            ...
            if (!string.IsNullOrWhiteSpace(CompatTemplate) &&
                CompatTemplate.Length > RelationsSettings.RimTalkCompatTemplateMaxLength)
            {
                CompatTemplate = CompatTemplate.Substring(0, RelationsSettings.RimTalkCompatTemplateMaxLength);
            }
        }
