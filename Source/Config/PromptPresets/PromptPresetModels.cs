...
namespace Ustas.RimAI.Communication.Relations.Config
{
    ...
    public sealed class PromptPresetChannelPayloads
    {
        ...
        public string RimTalkPersonaCopyTemplate = RelationsSettings.DefaultRimTalkPersonaCopyTemplate;
        ...
        public PromptPresetChannelPayloads Clone()
        {
            return new PromptPresetChannelPayloads
            {
                ...
                RimTalkPersonaCopyTemplate = RimTalkPersonaCopyTemplate ?? RelationsSettings.DefaultRimTalkPersonaCopyTemplate
            };
        }
    }
