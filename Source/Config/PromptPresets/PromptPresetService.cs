...
namespace Ustas.RimAI.Communication.Relations.Config
{
    internal sealed partial class PromptPresetService : IPromptPresetService
    {
        ...
        private static void NormalizeStore(RelationsSettings settings, PromptPresetStoreConfig store, bool persistWhenEmpty = true)
        {
        ...
        private static PromptPresetChannelPayloads CaptureCurrentPayload(RelationsSettings settings)
        {
        ...
        private static bool HasMeaningfulLegacyPayload(PromptPresetChannelPayloads payload)
        {
            ...
            if (payload.RimTalkSummaryHistoryLimit != 10 ||
                ...
                !string.Equals(
                    ...
                    NormalizeText(RelationsSettings.DefaultRimTalkPersonaCopyTemplate),
        ...
        private static void ApplyRimTalkCompatSettings(RelationsSettings settings, PromptPresetChannelPayloads payload, bool persistToFiles)
        {
            PromptPresetChannelPayloads data = payload ?? new PromptPresetChannelPayloads();
