...
namespace Ustas.RimAI.Communication.Relations.Diagnostics
{
    ...
    /// updates, scheduling notices, parse previews - the several hundred lines
    /// this module produced on every load whether or not anybody was reading
    /// them. Warnings and errors are deliberately absent from this class. A
    /// problem has to reach the player whether developer mode is on or not, so
    /// those calls stay on Verse.Log where they were, and hiding one behind a
    /// switch would be the opposite of what this project is for.
    /// </summary>
