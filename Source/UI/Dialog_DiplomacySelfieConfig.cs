...
namespace Ustas.RimAI.Communication.Relations.UI
{
    ...
    public sealed class Dialog_DiplomacySelfieConfig : Window
    {
        ...
        public Dialog_DiplomacySelfieConfig(Faction faction, Pawn negotiator)
        {
            ...
            RelationsSettings settings = Module.RelationsMod.Settings;
        ...
        private void ApplyPersistedState(RelationsSettings settings)
        {
            if (settings == null)
            {
                return;
        ...
        private void PersistUiState()
        {
            ...
            Module.RelationsMod.Instance?.WriteSettings();
        }
