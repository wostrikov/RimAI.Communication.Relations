...
internal sealed class RelationsSettingsTooltips
{
    static readonly Dictionary<int, string> TabTooltipKeys = new()
    {
    ...
    static readonly Dictionary<AIControlSection, string> AISectionTooltipKeys = new()
    {
        ...
        { AIControlSection.AidRequestSettings, "RimChat_AidRequestSettingsTooltip" },
        { AIControlSection.AirdropTradeSettings, "RimChat_AirdropTradeSettingsTooltip" },
        { AIControlSection.PrisonerRansomSettings, "RimChat_PrisonerRansomSettingsTooltip" },
    ...
    static readonly Dictionary<string, string> PromptSectionTooltipKeys = new(StringComparer.Ordinal)
    {
    ...
    static readonly Dictionary<string, string> RpgSectionTooltipKeys = new(StringComparer.Ordinal)
    {
    ...
    static readonly Dictionary<string, string> RpgFieldTooltipKeys = new(StringComparer.Ordinal)
    {
    ...
    internal void Register(Rect rect, string key)
    {
