...
internal sealed class RelationsPromptTemplateEditors
{
    readonly RelationsSettingsPages Pages;

    internal RelationsPromptTemplateEditors(RelationsSettingsPages pages)
    {
        Pages = pages;
    }
    ...
    RelationsSettings Settings => Pages.Settings;
        ...
        internal static readonly string[] PromptTemplateFieldKeys =
        {
        ...
        internal int _selectedPromptTemplateFieldIndex;
        internal Vector2 _promptTemplateFieldListScroll = Vector2.zero;
        internal Vector2 _promptTemplateEditorScroll = Vector2.zero;
        internal string _promptTemplateEditorBuffer = string.Empty;
        internal string _promptTemplateEditingKey = string.Empty;

        internal void DrawPromptTemplatesEditorScrollable(Rect rect)
        {
        ...
        internal void DrawPromptTemplateFieldList(Rect rect)
        {
            float rowHeight = 36f;
        ...
        internal void DrawPromptTemplateFieldEditor(Rect rect, PromptTemplateTextConfig templates)
        {
        ...
        internal PromptTemplateTextConfig EnsurePromptTemplateConfig()
        {
            Pages.PromptLegacy.SystemPromptConfigData.PromptTemplates ??= new PromptTemplateTextConfig();
            return Pages.PromptLegacy.SystemPromptConfigData.PromptTemplates;
        }

        internal static string GetPromptTemplateFieldValue(PromptTemplateTextConfig templates, string key)
        {
            return key switch
            {
        ...
        internal static void SetPromptTemplateFieldValue(PromptTemplateTextConfig templates, string key, string value)
        {
            switch (key)
            {
        ...
        internal static string GetPromptTemplateFieldLabel(string key)
        {
            return key switch
            {
        ...
        internal string GetCurrentPromptTemplateEditorText()
        {
            PromptTemplateTextConfig templates = EnsurePromptTemplateConfig();
            if (_selectedPromptTemplateFieldIndex < 0 || _selectedPromptTemplateFieldIndex >= PromptTemplateFieldKeys.Length)
            {
