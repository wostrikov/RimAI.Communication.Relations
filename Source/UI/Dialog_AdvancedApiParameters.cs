...
namespace Ustas.RimAI.Communication.Relations.UI
{
    public sealed class Dialog_AdvancedApiParameters : Window
    {
        ...
        public override void DoWindowContents(Rect inRect)
        {
            ...
            if (Widgets.ButtonText(tokensBtnRect, Config.RelationsSettings.GetMaxTokensLabel(settings.MaxTokens)))
            {
                ...
                foreach (int tier in MaxTokensTiers)
                {
                    ...
                    tokenOptions.Add(new FloatMenuOption(
                        Config.RelationsSettings.GetMaxTokensLabel(captured),
            ...
            if (settings.ThinkingEnabled)
            {
                ...
                if (Widgets.ButtonText(effortBtnRect, Config.RelationsSettings.GetReasoningEffortLabel(settings.ReasoningEffort)))
                {
                    ...
                    foreach (string level in new[] { "low", "medium", "high", "xhigh" })
                    {
                        ...
                        effortOptions.Add(new FloatMenuOption(
                            Config.RelationsSettings.GetReasoningEffortLabel(captured),
