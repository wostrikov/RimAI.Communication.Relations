...
{
    internal sealed class NativeRenderDiagnostic
    {
    ...
    internal static class NativeRpgPromptRenderer
    {
            ...
            out NativeRenderDiagnostic diagnostic)
        {
            ...
            diagnostic = new NativeRenderDiagnostic();
        ...
        private static void ApplyBindingDiagnostic(PawnBindingSpec binding, NativeRenderDiagnostic diagnostic)
        {
        ...
        private static void LogFailure(NativeRenderDiagnostic diagnostic)
        {
        ...
        private static bool ShouldEmitFailureLog(NativeRenderDiagnostic diagnostic, string kind)
        {
        ...
        private static string BuildFailureSignature(NativeRenderDiagnostic diagnostic, string kind)
        {
            return string.Join("|",
                kind ?? string.Empty,
