...
namespace Ustas.RimAI.Communication.Relations.Prompting
{
    ...
    internal static partial class UserDefinedPromptVariableService
    {
        ...
        private static void NormalizeVariables(Ustas.RimAI.Communication.Relations.Config.RelationsSettings settings)
        {
        ...
        private static void MigrateLegacyOverrides(Ustas.RimAI.Communication.Relations.Config.RelationsSettings settings)
        {
            if (settings == null)
            {
                return;
        ...
        private static void NormalizeFactionRules(Ustas.RimAI.Communication.Relations.Config.RelationsSettings settings)
        {
        ...
        private static void NormalizePawnRules(Ustas.RimAI.Communication.Relations.Config.RelationsSettings settings)
        {
        ...
        private static IEnumerable<PromptTemplateReferenceCandidate> EnumerateReferenceCandidates(Ustas.RimAI.Communication.Relations.Config.RelationsSettings settings)
        {
