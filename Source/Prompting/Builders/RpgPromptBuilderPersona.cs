...
{
        internal sealed class RpgPromptBuilderPersona : RpgPromptBuilderCollaborator
    {
        internal RpgPromptBuilderPersona(RpgPromptBuilder owner) : base(owner)
        {
        }
        ...
        public string BuildPawnPersonaBootstrapProfile(Pawn pawn)
        {
            ...
            Owner.AppendPersonaBackstory(sb, pawn);
            Owner.AppendPersonaTraits(sb, pawn);
            Owner.AppendPersonaCoreSkills(sb, pawn);
            Owner.AppendPersonaFactionContext(sb, pawn);
