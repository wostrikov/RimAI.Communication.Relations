...
namespace Ustas.RimAI.Communication.Relations.AI
{
 ...
 ///</summary>
    public sealed class DialogueCompressionOptions
    {
        ...
        public static DialogueCompressionOptions Default => FromSettings(RelationsMod.Settings);

        public static DialogueCompressionOptions FromSettings(RelationsSettings settings)
        {
