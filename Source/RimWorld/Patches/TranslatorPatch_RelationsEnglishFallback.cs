...
namespace Ustas.RimAI.Communication.Relations.Patches
{
    ...
    public static class TranslatorPatch_RelationsEnglishFallback
    {
        ...
        private static void Postfix(string __0, ref TaggedString __1, ref bool __result)
        {
            ...
            if (!RelationsEnglishKeyFallbackCatalog.TryGetValue(__0, out string fallback))
            {
                return;
            }
    ...
    internal static class RelationsEnglishKeyFallbackCatalog
    {
        ...
        private static Dictionary<string, string> LoadEnglishKeyedDictionary()
        {
            ...
            string rootDir = RelationsMod.Instance?.Content?.RootDir
