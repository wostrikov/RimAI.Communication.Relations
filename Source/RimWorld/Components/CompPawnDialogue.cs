...
namespace Ustas.RimAI.Communication.Relations.Comp
{
    public class CompPawnDialogue : ThingComp
    {
        public override IEnumerable<FloatMenuOption> CompFloatMenuOptions(Pawn selPawn)
        {
            ...
            RelationsTrackedEntityRegistry.TrackPawn(selPawn);
            RelationsTrackedEntityRegistry.TrackPawn(targetPawn);
            ...
            if (RelationsMod.Settings == null || !RelationsMod.Settings.EnableRPGDialogue)
            {
            ...
            if (nearbyPawns.Count >= 1)
            {
                ...
                yield return new FloatMenuOption(groupLabel, () =>
                {
                    ...
                    foreach (Pawn p in captured)
                        RelationsTrackedEntityRegistry.TrackPawn(p);
                    DialogueWindowCoordinator.TryOpen(
